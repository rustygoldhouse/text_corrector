...
•
Options
Hi, thanks for the port to Python. I was wondering if there was a way to add words after it has been built (to save the time in rebuilding it from scratch)? Also, my set of just over 100K words (phash signatures) with maxeditdistance=3 takes about 30 minutes to build on a MacBook Pro - 2.8 GHz Intel Core i7 with 16 GB 2133 MHz LPDDR3 in Jupyter Notebook. Am I doing something wrong? My full dataset will be close to 100 million and I fear it will take way too long…
...
There's this blog post from the creator

https://towardsdatascience.com/symspell-vs-bk-tree-100x-faster-fuzzy-string-search-spell-checking-c4f10d80a078

But I guess if you understand the BK-tree data structure, it would suffice
...
Introduction To Manual Feature Engineering
In-Depth Analysis & Visualisations - Avito
In-Depth Analysis & Visualisations - Avito
© 2018 Kaggle Inc
